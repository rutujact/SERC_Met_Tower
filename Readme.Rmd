---
title: "Met Tower Package Readme and Updater"
...
fun.mettower(year = year, df_dict0 = df_dict0, met.Rs.QC.3 = met.Rs.QC.3)
```
...
```{r Chunk 4, eval = TRUE, echo = FALSE, message = FALSE, fig.align = 'center', out.width = "100%", fig.pos = 'H', fig.cap = "Temperature offset changes after 2017-03-09 onwards. Data before removing extreme values"}
knitr::include_graphics("figures/graph.1_Tower Temp offset changes by 10 deg C 2017-03-09 onwards.png")
```

```{r Chunk 5, eval = TRUE, echo = FALSE, message = FALSE, fig.align = 'center', out.width = "100%", fig.pos = 'H', fig.cap = "Rs data at Forest Floor has data gaps in the recent years. Data before removing extreme values."}
knitr::include_graphics("figures/graph.2_Daily Met Tower cleaned Rs data from Pat Neale Tower Top & Forest floor.png")
```
```{r Chunk 6, eval = TRUE, echo = FALSE, message = FALSE, fig.align = 'center', out.width = "100%", fig.pos = 'H', fig.cap = "Daily met data at Tower Top after cleaning",}
knitr::include_graphics("figures/graph.3_daily_met_data_by_year_Tower-Top.png")
```
```{r Chunk 7, eval = TRUE, echo = FALSE, message = FALSE, fig.align = 'center', out.width = "100%", fig.pos = 'H', fig.cap = "Annual summary met data afer cleaning",}
knitr::include_graphics("figures/graph.4_annual_met_data.png")
```
```{r Chunk 8, eval = TRUE, echo = FALSE, message = FALSE, fig.align = 'center', out.width = "100%", fig.pos = 'H', fig.cap = "Daily Forest Floor data after gap-filling from Green house station"}
knitr::include_graphics("figures/graph.5_daily_met_data_by_year_forestfloor.png")
```
```{r Chunk 9, eval = TRUE, echo = FALSE, message = FALSE, fig.align = 'center', out.width = "100%", fig.pos = 'H', fig.cap = "Seasonal contrast between Tower Top and Forest Floor, daily data after cleaning and gap filling (only for forest floor)"}
knitr::include_graphics("figures/graph.6_Tower Top vs. Forest Floor.png")
```
```{r Chunk 10, eval = TRUE, echo = FALSE, message = FALSE, fig.align = 'center', out.width = "100%", fig.pos = 'H', fig.cap = "Climatic mean +- SE for Tower Top and Forest Floor showing seasonal contrast (cleaned and, for forest floor, gap-filled data)"}
