...
```{r, Section 3, eval = TRUE}
## Refers to Section 3.2.b above
# Set unacceptable data range
# If you were to change this range, set it here
include.figures <- TRUE # TRUE includes figure in knitted document. Turn to FALSE to save to figures folder instead.
year <- 2019
df_dict0 <-
  data.frame(
...
fun.mettower(year = year, df_dict0 = df_dict0, met.Rs.QC = met.Rs.QC, include.figures = include.figures)
```
